# -*- coding: utf-8 -*-
"""
Created on Sat Oct 19 22:27:12 2024
...
class NVVanPhong:
    def __init__(self, ma_nv, ho_ten, luong_co_ban, so_ngay):
        ...
        self.luong_hang_thang = self.calculate_salary()

    def calculate_salary(self):
        return self.luong_co_ban * self.so_ngay
...
class NVBanHang:
    ...
    def calculate_salary(self):
        return self.luong_co_ban * self.so_san_pham
